...
/usr/bin/cp /tmp/monit-$_MONIT_VERSION/libmonit/src/system/Link.c /tmp/monit-$_MONIT_VERSION/libmonit/src/system/Link.c.original
/usr/bin/cp $_CYGMONIT_DEV_VERSION/Monits/$_MONIT_VERSION/src/Link.c.patch /tmp/monit-$_MONIT_VERSION/libmonit/src/system
/usr/bin/mkdir -p /tmp/monit-$_MONIT_VERSION/libmonit/src/system/os/cygwin
/usr/bin/cp /tmp/monit-$_MONIT_VERSION/libmonit/src/system/os/linux/Link.inc /tmp/monit-$_MONIT_VERSION/libmonit/src/system/os/cygwin/Link.inc
/usr/bin/patch -p1 /tmp/monit-$_MONIT_VERSION/libmonit/src/system/Link.c /tmp/monit-$_MONIT_VERSION/libmonit/src/system/Link.c.patch
