...
set "_MONIT_VERSION=5.10"
set "_MONIT_FILE=monit-%_MONIT_VERSION%.tar.gz"

set "_CYGWIN_ARCHITECTURE=x86"
set "_CYGWIN_VERSION=1.7.35.1"

set "_SETUP_VERSION=2.870"
...
set "_PROXY="
set "_SITE= http://ctm.crouchingtigerhiddenfruitbat.org/pub/cygwin/circa/2015/04/26/121039"
