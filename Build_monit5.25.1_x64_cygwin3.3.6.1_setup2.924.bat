...
set "_MONIT_VERSION=5.25.1"
set "_MONIT_FILE=monit-%_MONIT_VERSION%.tar.gz"

set "_CYGWIN_ARCHITECTURE=x64"
set "_CYGWIN_VERSION=3.3.6.1"

set "_SETUP_VERSION=2.924"
...
set "_PROXY="
set "_SITE=http://ctm.crouchingtigerhiddenfruitbat.org/pub/cygwin/circa/64bit/2022/11/23/063529"
