...
set "_MONIT_VERSION=5.34.0"
set "_MONIT_FILE=monit-%_MONIT_VERSION%.tar.gz"

set "_CYGWIN_ARCHITECTURE=x64"
set "_CYGWIN_VERSION=3.5.4.1"

set "_SETUP_VERSION=2.932"
...
set "_PROXY="
set "_SITE=http://ctm.crouchingtigerhiddenfruitbat.org/pub/cygwin/circa/64bit/2024/08/27/133009/"
...
:development
	...
	set "_PACKAGES=autoconf,diff,diffutils,patch,xz,automake,make,gcc-core,m4,bison,libtool,flex,libssl-devel,cygwin-devel,libcrypt-devel,zlib-devel,cygport,git"
...
:production
	...
	set "_PACKAGES=crypt,cygrunsrv,libcrypt2,procps,vim,git,openssh,cron,curl,dos2unix,diffutils,p7zip,screen,unzip,zip,chere"	
